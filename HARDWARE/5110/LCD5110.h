...
#define LCD5110_PORT 	GPIOA					//5110所在端口
#define LCD_SCLK_BIT 	BIT8					//SCLK端口位
#define LCD_SDIN_BIT 	BIT9					//SDIN端口位
#define LCD_DC_BIT 	 	BIT10					//DC端口位
#define LCD_SCE_BIT		BIT12					//SCE端口位
#define LCD_REST_BIT 	BIT11					//REST端口位
